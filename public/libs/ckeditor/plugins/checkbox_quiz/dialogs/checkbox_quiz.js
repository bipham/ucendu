    ...
    return {
        ...
        onOk: function() {
            ...
            if (last_option) {
                ...
                var html = '<span class="label-checkbox key-label"><strong>' + value_quiz + '</strong></span> <input type="checkbox" class="question-quiz question-checkbox question-' + class_quiz + ' ' + l_option +'" name="question-' + class_quiz + '" value="' + value_quiz + '" onclick="bitest(this)" data-qnumber="' + data_ques +'"/>' + opt_quiz;
                data_ques++;
